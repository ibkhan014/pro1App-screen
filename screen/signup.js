        ...
        return (
            ...
            <View style={{ flex: 1, marginTop: 255, borderRadius: 25, marginLeft: 50, marginRight: 33, marginBottom: 55, position: 'relative', width: 250, borderWidth: 3, backgroundColor: 'white' }}>
              ...
              <View style={{ flex: 1, flexDirection: 'row', borderRadius: 2, marginTop: 5 }}>
                <TouchableOpacity>
                  <Text style={{ fontSize: 22, borderWidth: 1, textAlign: 'center', backgroundColor: 'white', borderRadius: 20, height: 40, width: 110, margin: 5 }}>login</Text>
                </TouchableOpacity>
                <TouchableOpacity>
                  <Text style={{ fontSize: 22, borderWidth: 1, textAlign: 'center', backgroundColor: '#F47554', borderRadius: 20, height: 40, width: 110, margin: 5 }}>signUp</Text>
                </TouchableOpacity>
              </View>
              <View style={{ marginBottom: 200,marginTop:30 }}>
                ...
                <TouchableOpacity style={{ top: 20 }}>
                  <Text style={{ borderWidth: 1, backgroundColor: '#F47554', textAlign: 'center', height: 50, top: 15, borderRadius: 40, fontSize: 26,color:'white' }}>SignUP</Text>
                </TouchableOpacity>
