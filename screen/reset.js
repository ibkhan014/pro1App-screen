...
export default class Reset extends Component {
    render() {
        return (
            <View style={{ flex: 1 }}>
                <Text style={{ alignSelf: 'center', marginVertical: 30, fontSize: 23, fontWeight: 'bold' }}> ForgotPassword </Text>
                <View style={{marginLeft:20}}>
                    <Text style={{ fontSize: 20, fontWeight: 'bold' }}> ForgotPassword </Text>
                    <Text style={{ fontSize: 15,padding:10 }}>Enter Your email address and we will send you a reset instructions. </Text>
                </View>
